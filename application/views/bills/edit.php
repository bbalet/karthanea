...
<input name="txtDate" id="txtDate" type="text" class="form-control datepicker" value="12/23/2015" readonly="readonly">

<label for="txtDueDate">Due Date : </label>
<input name="txtDueDate" id="txtDueDate" type="text" class="form-control datepicker" value="12/31/2015" readonly="readonly">

<label for="txtTotalDue">Total Due:</label>
<input id="txtTotalDue" name="txtTotalDue"  type="number" step="0.01" class="form-control" value="10">

<label for="txtTotalPaid">Total Paid:</label>
<input id="txtTotalPaid" name="txtTotalPaid"  type="number" step="0.01" class="form-control" value="5">
