<?php 
/**
 * This view displays the list of bills of a client.
...
<h1>Bills of client <a href="<?php echo base_url();?>clients/22/dashboard">Georges DURAND</a></h1>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="bills" width="100%">
    ...
    <tr>
        ...
        <td><a href="<?php echo base_url();?>contracts/223/view" title="contract's details">Car 1245XY12</a></td>
        <td>03/25/2016</td>
        <td>03/31/2016</td>
        <td>25 $</td>
        <td>0 $</td>
    ...
    <tr>
        <td data-order="598">
            598&nbsp;
            <div class="pull-right">
                <a href="<?php echo base_url();?>bills/598/view" title="bill's details"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
                &nbsp;
                <a href="#" class="confirm-delete" data-id="598" title="delete"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
            </div>
        </td>
        <td><a href="<?php echo base_url();?>contracts/223/view" title="contract's details">Moto 125BC45</a></td>
        <td>12/23/2015</td>
        <td>12/31/2015</td>
        <td>5 $</td>
        <td>5 $</td>
